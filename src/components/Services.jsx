      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          <div className="inline-block border border-gray-300 rounded-full px-5 py-1.5 text-sm text-gray-600 font-bold mb-8 shadow-sm bg-white">
            My Development Process          </div>
          <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-black text-gray-900 leading-tight mb-6 tracking-tight max-w-3xl">
            Building modern, responsive websites using React, Node.js, Express.js, and MongoDB professionally.            {/* Hand-drawn arrow */}
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="Plan"
            text="Understand the project requirements, user needs, and create a clear development roadmap."
          ...
          <TagCard
            number="02"
            title="Design"
            text="Create clean, responsive, and user-friendly UI designs with modern layouts."
          ...
          <TagCard
            number="03"
            title="Develop"
            text="Build fast and scalable applications using React, Node.js, Express.js, and MongoDB."
          ...
          <TagCard
            number="04"
            title="Deploy"
            text="Test, optimize, deploy, and maintain the application for the best performance."
